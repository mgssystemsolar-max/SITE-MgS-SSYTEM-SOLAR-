...
export default function SolarGuide() {
  ...
  return (
    <section id="comece-aqui" className="py-20 bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {cards.map((card, index) => (
            <div key={index} className="bg-solar-card p-8 rounded-2xl shadow-lg border-b-4 border-solar-orange hover:-translate-y-2 transition-transform duration-300">
